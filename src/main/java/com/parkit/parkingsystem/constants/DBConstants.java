...
public class DBConstants {
  ...
  public static final String UPDATE_TICKET_INTIME = "update ticket intime set IN_TIME=?";
  public static final String SEARCH_VEHICLE_REG_NUMBER =
      "select t.VEHICLE_REG_NUMBER from ticket t where t.VEHICLE_REG_NUMBER=? and t.OUT_TIME is not null";
}
